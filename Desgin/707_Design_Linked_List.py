#!python3
# https://leetcode.com/problems/design-linked-list/discuss/148773/Python-AC-short-and-simple-linked-list-solution
# 双端链表
class Node:
...
class MyLinkedList:
    ...
    def addAtIndex(self, index, val):
        if 0 <= index <= self.size // 2:
            ...
            self.add(self.backward(self.size - 1, self.size + index, self.tail.pre), val)
